...
@click.command()
@click.option("--wandb_project", default="mlops", help="Name of Weights & Biases project")
@click.option("--wandb_entity", default="pablocursos2020", help="Name of Weights & Biases entity")
@click.option(
    "--data_artifact",
    default="pablocursos2020/mlops/NYC-Taxi:v0",
...
def run_train(
    ...
    artifact = wandb.Artifact(f"taxi-regressor-model", type="model")
